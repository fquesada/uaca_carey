...
class Habilidadnoequivalente extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, competencia, evaluacioncandidato, calificacion', 'required'),
			...
			array('id, nombre, competencia, evaluacioncandidato, calificacion, puestopotencial1, puestopotencial2, puestopotencial3', 'safe', 'on'=>'search'),
		);
	}
