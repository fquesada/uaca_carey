 ...
 * @property string $indicadorcompetencia
 *
...
class Competencia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('competencia, indicadorcompetencia', 'required'),
			array('competencia', 'length', 'max'=>800),
			array('indicadorcompetencia', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, competencia, indicadorcompetencia', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'itemcompetencias' => array(self::HAS_MANY, 'Itemcompetencia', 'Competencia_id'),
	...
	public function search()
	{
		...
		$criteria->compare('indicadorcompetencia',$this->indicadorcompetencia,true);
