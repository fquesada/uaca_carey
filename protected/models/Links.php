...
class Links extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('url, contadorenvios, estado', 'required'),
            array('contadorenvios, estado', 'numerical', 'integerOnly'=>true),
    ...
    public function relations()
    {
        ...
        return array(
            '_evaluacioncompetencias' => array(self::HAS_MANY, 'Evaluacioncompetencias', 'links'),
            '_evaluaciondesempeno' => array(self::HAS_MANY, 'Evaluaciondesempeno', 'links'),
        );
    }
