...
<div id="divhabilidad" style="display: none">
    ...
    <div class="row">
            ...
            <div id="txtnombrehabilidaderror" class="errorprocesoevaluacion">Debe ingresar una habilidad.</div>
    </div> 
    ...
    <div class="row">
            ...
            <div id="txtareadescripcionhabilidaderror" class="errorprocesoevaluacion">Debe ingresar la descripción de la habilidad.</div>
    </div>  
    ...
    <div class="row">
            ...
            <div id="dllponderacionerror" class="errorprocesoevaluacion">Debe seleccionar una ponderación.</div>
    </div>  
