...
<?php echo CHtml::beginForm($this->createUrl('procesoevaluacion/crear'),'post', array('id'=>'formcrearprocesoevaluacion'))?>                      
<button  id="btnformcrearprocesoevaluacion" type="submit" class="sexybutton sexysimple"><span class="add">Crear proceso evaluación</span></button>
...
//                ),
			...
			'class'=>'CButtonColumn',
                        ...
                        'deleteButtonUrl'=>'Yii::app()->controller->createUrl("procesoevaluacion/borrar", array("id"=>$data["id"]))',
                        ...
                        'buttons'=>array(
                            'agregarpersonas'=>array(
                                ...
                                'url'=>'Yii::app()->createUrl("procesoevaluacion/agregarpersonas", array("id"=>$data["id"]))'
                                
                            ),
                            'habilidades'=>array(
                                'label'=>'Ver Evaluaciones Especiales',
                                'imageUrl'=>Yii::app()->request->baseUrl.'/images/icons/silk/award_star_gold_3.png',
                                'url'=>'Yii::app()->createUrl("procesoevaluacion/habilidadesespeciales", array("id"=>$data["id"]))',                               
                                'options'=>array(  
                                    'ajax'=>array(
                                            'type'=>'POST',
